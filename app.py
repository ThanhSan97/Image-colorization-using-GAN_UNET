...
# new_image = np.uint8(generated_image * 255)
# if generated_image[0, 0, 0] == 0:
#     print("Mảng ảnh đang là RGB")
# else:
#     print("Mảng ảnh đang là BGR")

# Đảm bảo rằng kết quả có kích thước 720x720 (chẳng hạn bằng cách cắt hoặc chèn)
# generated_image = cv2.resize(new_image, (720, 720))
# image = cv2.cvtColor(generated_image, cv2.COLOR_RGB2BGR)
# Lưu ảnh kết quả
